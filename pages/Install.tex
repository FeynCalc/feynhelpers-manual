...
Copy the directory \texttt{ferm6} to
\texttt{FileNameJoin[\allowbreak{}\{\allowbreak{}\$UserBaseDirectory,\ \allowbreak{}"Applications",\ \allowbreak{}"FeynCalc",\ \allowbreak{}"AddOns",\ \allowbreak{}"FeynHelpers",\ \allowbreak{}"ExternalTools",\ \allowbreak{}"Fermat"\}]}.
...
website}. The content should be extracted to
\texttt{FileNameJoin[\allowbreak{}\{\allowbreak{}\$UserBaseDirectory,\ \allowbreak{}"Applications",\ \allowbreak{}"FIRE"\}]}.

We recommend to enable support for flint, zstd, lthreads, tcmalloc,
snappy and zlib via

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{.}\SpecialCharTok{/}\NormalTok{configure }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{zlib }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{snappy }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{lthreads }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{tcmalloc }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{zstd }\SpecialCharTok{{-}{-}}\AttributeTok{enable\_}\NormalTok{flint}
\end{Highlighting}
\end{Shaded}
...
Notice that as of 12.01.2025 FIRE 7 cannot properly handle integrals
with 2 propagators. The issue and a possible fix can be found
\href{https://gitlab.com/feynmanintegrals/fire/-/issues/40\#note_2994322049}{here}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gfortran qgraf}\FloatTok{{-}3.}\FunctionTok{x}\NormalTok{.}\FunctionTok{y}\NormalTok{.f08 }\SpecialCharTok{{-}}\FunctionTok{o}\NormalTok{ qgraf}
\end{Highlighting}
\end{Shaded}
