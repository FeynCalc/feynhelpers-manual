...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{(*\{\{4242, \{{-}7, 1, 1, 9, 1\}\}, \{4242, \{{-}6, 0, 2, 8, 1\}\}, }
\CommentTok{ \{4242, \{{-}6, 1, 1, 8, 1\}\}, \{4242, \{{-}6, 1, 2, 8, 1\}\}, }
\CommentTok{ \{4242, \{{-}5, {-}1, 3, 7, 1\}\}, \{4242, \{{-}5, 0, 2, 7, 1\}\}, }
\CommentTok{ \{4242, \{{-}5, 0, 3, 7, 1\}\}, \{4242, \{{-}5, 1, 1, 7, 1\}\}, }
\CommentTok{ \{4242, \{{-}5, 1, 2, 7, 1\}\}, \{4242, \{{-}5, 1, 3, 7, 1}\RegionMarkerTok{\}\}\}}\CommentTok{*)}
\end{Highlighting}
\end{Shaded}
